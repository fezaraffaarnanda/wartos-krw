...
from core.db_helpers import _fetch_existing_urls, _log_scrape_run
...
def _build_article_row(article: dict, source_label: str) -> dict:
    ...
    from core.kbli_utils     import predict_kbli_label
    from core.aktivitas_utils import predict_aktivitas_label
