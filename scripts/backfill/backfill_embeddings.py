"""
scripts.backfill.backfill_embeddings — Backfill / regenerasi embedding untuk artikel existing
...
Mode force (--force):
    ...
    python -m scripts.backfill.backfill_embeddings --force
...
from ai.embeddings import _build_embedding_client, batch_embed_articles
