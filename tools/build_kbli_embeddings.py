...
Skrip ini:
1. Membaca masters/KBLI_2025_Kode-Judul_Deskripsi.xlsx (22 baris: kode A–V)
...
Pemakaian:
    python tools/build_kbli_embeddings.py
    python tools/build_kbli_embeddings.py --force   # regenerate semua, termasuk yang sudah ada
"""
...
# Tambahkan root project ke path agar import core/ berfungsi
...
from core.embeddings import _build_embedding_client, generate_embedding
...
_MASTER_XLSX = os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
    "masters",
    "KBLI_2025_Kode-Judul_Deskripsi.xlsx",
)
